export default function SecondShowcase() {
    return (
      <>
        <div className="relative w-full h-[180px] bg-dark rounded-[20px] overflow-hidden group mb-8">
          <img
            src="https://daisyui.com/images/stock/photo-1606107557195-0e29a4b5b4aa.jpg"
            alt="image"
            className="w-full h-full object-cover transition-transform transform scale-100 group-hover:scale-105"
          />
          <div className="absolute bottom-0 left-0 w-full text-white p-4 bg-black bg-opacity-50 backdrop-blur-md backdrop-filter">
            <h3 className="text-lg">Global IT Web App</h3>
