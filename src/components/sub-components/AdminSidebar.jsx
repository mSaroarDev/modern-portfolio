      ...
      <div className="side-navbar">
        <div className="flex flex-col w-full">
          <div className="brand my-16 p-7">
            <h3 className="text-white textLg font-bold">
              Hello, <span className="capitalize">Muhammad Saroar</span>
            </h3>
          </div>
          ...
          <div className="menus flex flex-col w-full">
            ...
            <Link className="sideLink" href={"/dashboard/blogs"}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
            ...
            <Link className="sideLink" href={"/dashboard/contacts"}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
            ...
            <Link className="sideLink" href={"/dashboard/subscriptions"}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
